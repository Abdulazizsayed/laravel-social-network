...
<div class="content-holder">
    <div class="container content pt-3 pb-3">
        ...
        <div class="card post post{{$post->id}} text-white bg-primary mb-3 mt-3">
            ...
            <div id="comment{{$comment->id}}" class="card-body pt-0 pb-0 comment{{$comment->id . $rand2}}">
                <div class="row">
                    <div class="col-md-1">
                        {{-- Commenter image --}}
                    ...
                    <div class="col-md-11">
                        ...
                        {{-- Reply --}}
                        <div id="reply{{$reply->id}}" class="card-body p-2 mt-4 reply{{$reply->id . $rand3}} border rounded">
                            <div class="row">
                                <div class="col-md-1">
                                    {{-- Replier image --}}
