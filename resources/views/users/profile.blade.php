...
<div class="content-holder">
    <div class="container content pt-3 pb-3">
        <div class="profile-info text-center">
            <img class="rounded-circle border border-primary" src="{{ $user->image ? asset('storage/' . $user->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="300px" height="300px" alt="User photo">
            <h3 class="pt-4">{{$user->name}} <span class="text-muted">( {{$user->nickname}} )</span></h3>
            <p class="lead" width="300px">{{$user->bio}}</p>
            @if ($user->id == auth()->user()->id)
            <a href="{{asset('/users/editProfile')}}" class="btn btn-primary">Edit profile</a>
            @else
            <form class="follow-form d-inline">
                ...
                <button class="btn btn-primary" name="submit" type="submit">Unfollow</button>
                @else
                <button class="btn btn-primary" name="submit" type="submit">Follow</button>
                @endif
            </form>
            <a href="{{asset('users/messages/' . $user->id)}}" class="btn btn-primary">Message</a>
            @endif
        </div>
            ...
            <div class="card post post{{$post->id}} text-white bg-primary mb-3 mt-3">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-1">
                            {{-- Post image --}}
                            <img class="rounded-circle" src="{{ $post->user->image ? asset('storage/' . $post->user->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="User photo">
                        </div>
                        <div class="col-md-10">
                            {{-- Poster name --}}
                                    ...
                                    <div class="modal-content">
                                        ...
                                        @foreach ($post->likes as $like)
                                            <div class="row text-secondary mt-3 liker">
                                                <div class="col-md-1">
                                                    <img class="rounded-circle" src="{{ $like->user->image ? asset('storage/' . $like->user->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="User photo">
                                                </div>
                ...
                <div class="card-body pt-0 pb-0 comment{{$comment->id . $rand2}}">
                    <div class="row">
                        <div class="col-md-1">
                            {{-- Commenter image --}}
                            <img class="rounded-circle" src="{{ $comment->user->image ? asset('storage/' . $comment->user->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="Commenter photo">
                        </div>
                        <div class="col-md-11">
                            ...
                            <div class="card-body p-2 mt-4 reply{{$reply->id . $rand3}} border rounded">
                                <div class="row">
                                    <div class="col-md-1">
                                        {{-- Replier image --}}
                                        <img class="rounded-circle" src="{{ $reply->user->image ? asset('storage/' . $reply->user->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="Replier photo">
                                    </div>
                                    <div class="col-md-11">
                            ...
                            <div class="card-body p-2 mt-4 reply border rounded preview-reply{{$comment->id}}" hidden>
                                <div class="row">
                                    <div class="col-md-1">
                                        {{-- Replier image --}}
                                        <img class="rounded-circle" src="{{ auth()->user()->image ? asset('storage/' . auth()->user()->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="Replier photo">
                                    </div>
                                    <div class="col-md-11">
                                        <div>
                                            {{-- Replier name --}}
                ...
                <div class="card-body pt-0 pb-0 comment preview-comment{{$post->id}}" hidden>
                    <div class="row">
                        <div class="col-md-1">
                            {{-- Commenter image --}}
                            <img class="rounded-circle" src="{{ auth()->user()->image ? asset('storage/' . auth()->user()->image->file_name) : asset('storage/images/users/profile/default_user_photo.jpg') }}" width="40px" height="40px" alt="Commenter photo">
                        </div>
                        <div class="col-md-11">
                            <div>
                                {{-- commenter name --}}
